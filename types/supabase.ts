// 자동 생성 — 스키마 변경 시 재실행:
// SUPABASE_ACCESS_TOKEN=<token> npx supabase gen types typescript --project-id eefgpaqjdhgsqljknsfp > types/supabase.ts
  ...
  public: {
    Tables: {
      ...
      custom_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "custom_groups_couple_id_fkey"
            columns: ["couple_id"]
            isOneToOne: false
      ...
      todo_items: {
        Row: {
          ...
          date: string | null
          group: Database["public"]["Enums"]["todo_group"]
          id: string
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "todo_items_couple_id_fkey"
            columns: ["couple_id"]
            isOneToOne: false
            referencedRelation: "couples"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "todo_items_custom_group_id_fkey"
    ...
    Functions: {
      create_invite_code: { Args: never; Returns: Json }
      use_invite_code: { Args: { p_code: string }; Returns: Json }
    }
    Enums: {
      todo_group: "together" | "individual" | "other" | "custom"
    }
    CompositeTypes: {
      [_ in never]: never
    }
